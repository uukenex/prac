...
<body>
	<img alt="PassFind"
		src="<%=request.getContextPath()%>/join_icons/pass_find.png">
	<c:url value="/searchPass" var="searchPass" />
	<form action="${searchPass}">
		<fieldset>
			<table cellpadding="7.5">
				<tr>
					<th><label for="id">아이디</label>
					<td><input type="text" id="id" name="id"
						placeholder="아이디 입력" class="inputTextStyle"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="submit" value="다음" class="button2"></td>
				</tr>
			</table>
		</fieldset>
	</form>
