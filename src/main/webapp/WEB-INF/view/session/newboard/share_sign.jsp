...
<div class="nb" data-room="share">
  ...
  <div class="nb-board">
    ...
    <div class="nb-room-note">📎 공유게시판 — 누구나 수정 가능한 문서, 버전 이력이 남습니다</div>
    <form action="<%=request.getContextPath()%>/newboard/shareWrite" method="post" id="nbFrm">
      <div class="nb-field">
        <label>제목</label>
