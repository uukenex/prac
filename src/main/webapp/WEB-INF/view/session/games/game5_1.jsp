...
<BODY onload="init()">
	...
	var dragobject = {
		...
		moveit : function(e){
			...
			if (this.dragapproved == 1) {
				...
				var top_px = this.offsety + evtobj.clientY - this.y;
				var left_px = this.offsetx + evtobj.clientX - this.x;
				
				$('#weapon_motion').css({top: top_px, left: left_px});
				$('#weapon').css({top: top_px+63-18, left: left_px+37*2});
    			$('#char_heat').css({top: top_px, left: left_px});
    			$('#charimg').css({top: top_px, left: left_px});
	...
	<section id="space" class='space'>
		<div id= "char" >
			<div id="char_heat" class="drag" ></div>
		</div>
