...
<body>
					...
					<div class="8u 12u(mobile) important(mobile)">
						<section class="middle-content">
							<div style="background:#FFF6E5; border:1px solid #E0C48A; border-radius:8px; padding:10px 14px; margin-bottom:14px; font-size:13px;">
								...
								<a href="<%=request.getContextPath()%>/session/newboard/secret"><b>새 비밀게시판</b></a>에서 이용하세요.
							</div>
							...
							<ul id="writeNsearchBar">
								...
								<li>
									<a href="/session/secretsign" ><input type="submit" value="글쓰기" class="writeBoard"></a>
							...
							<form>
								...
								<p id="pageNumber">
									...
									%>
									<a href="/session/secret?page=<%=i%>"><%=i%> </a>
									<%}%>
								</p>
							</form>
						</section>
	...
	<%session.removeAttribute("message");%>
		...
		<c:url value="/session/secretSearch" var="secretSearch" />
