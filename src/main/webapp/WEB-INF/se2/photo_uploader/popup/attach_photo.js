	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  :'/file_uploader',	//editorController //샘플 URL입니다.
 	        sCallback : '/se2_callback',	//editorController //업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	        //sCallback : '/se2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	        //sCallback : '/se2_callback',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
