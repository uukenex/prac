...
-- MONSTER_ID 106(6블록)만 추가 스펙업: "55층부터 소울주춤 유저 스펙 기준 일반몹 승률
-- 50%, 강화몹은 10%대(사실상 통과 불가)로 스펙업해달라" 요청. 이 계정 파티(나기ROGUE
-- G5 30%회피/리오MAGE G4/코하루PRIEST G4, 레인보우 시너지 ATK/DEF+10%, DICE_12,
-- 몬스터 전용 랜덤주사위 6~12 포함)로 Node.js 몬테카를로 시뮬레이션해서 HP/ATK/DEF
-- 조정(강화몹은 코드상 항상 정확히 2배라 "일반 50%/강화 10%"를 동시에 정확히 맞추는
