...
public interface BotNewService {
    ...
    int countHellBagsInBuffPeriod(String userName, int itemId, java.util.Date buffStart);
    ...
    /** 유저당 1행 SP/GP 잔액 MERGE */
    void upsertPointNewRank(String userName);
 ...
 // Top 3 레벨 랭킹
    ...
    List<HashMap<String,Object>> selectAllTodayBagCounts();
