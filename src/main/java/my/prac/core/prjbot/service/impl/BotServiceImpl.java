...
public class BotServiceImpl implements BotService {
	...
	public List<String> selectRoomList2(HashMap<String, Object> hashMap){
		return botDAO.selectRoomList2(hashMap);
	}
	...
	public String selectHourCheckCountForPoint(HashMap<String,Object> map){
		...
		return botDAO.selectHourCheckCountForPoint(map);
	}
	...
	public List<HashMap<String, Object>> selectHellTop3Contributors(HashMap<String, Object> hashMap){
		return botDAO.selectHellTop3Contributors(hashMap);
	}
