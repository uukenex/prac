...
public class BossAttackS3Controller {
    ...
    @Resource(name = "core.prjbot.BotService")    BotService    botService;   // 쿨타임 체크용
    ...
    private String calcHellBossReward(String roomName, int seq) {
        ...
        for (int i = 0; i < contributors.size(); i++) {
            int cnt   = Integer.parseInt(contributors.get(i).get("CNT").toString());
            int score = Integer.parseInt(contributors.get(i).get("SCORE").toString());
