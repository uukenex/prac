 ...
 *   /탑올라가기        — 마을에서만 사용, 이 구간 보스를 이미 처치했으면 바로 위 10층 구간 마을로 이동 (예: 10층 마을 → 20층 마을) (별칭: /탑업)
...
public class Season5Controller {
    ...
    public String ascendVillage(HashMap<String, Object> map) {
        return s5Service.ascendVillage(userNameOf(map));
    }
